<?php
session_start();
// Soln for Enable/Disable of Submit : http://www.phpbuilder.com/board/showthread.php?t=10347062
?>
...
<link rel="stylesheet" type="text/css" href="css/flowConsumerOnboarding.css">
...
<body onLoad='new showLocalTime("timecontainer", "server-php", 0, "short")'>
    ...
    <iframe style="position: absolute; visibility: visible; width: 2em; height: 2em; top: -29px; left: 0pt; border-width: 0pt;" title="Text Resize Monitor" id="_yuiResizeMonitor"></iframe>
    
    <div style="z-index: 17; visibility: hidden;" id="balloonCalloutPanel_c" class="yui-panel-container balloon yui-overlay-hidden"><div
style="visibility: inherit; top: 873px; left: 442px;" class="yui-module yui-overlay yui-panel posUnder" id="balloonCalloutPanel"><div 
...
<div id="main"><div class="layout1"><form class="safeSubmit" method="post" id="signup_form" name="signup_form" action="reg_action.php" onsubmit="return validate_form(this);">
<p>Please fill in all fields.</p>
<p class="group"><label for="rollno">Roll No./Username</label><span 
class="help">You will use this to log in</span><span 
class="field"><input id="rollno" class="large" name="rollno" type="text" onblur="if(this.value.length!=0) ValidRollno(this.value)"></span>
</p>
...
class="field">
<input id="email" class="large" name="email" type="text" onblur="if(this.value.length!=0) ValidEmail(this.value)">
<!-- <input id="email" class="large" name="email" type="text" onchange="ValidEmail(this.value)"> -->
</span><div id="txtHint"><p class="buttons"><button type="submit" id="next.x" name="next.x" +
class="primary">Create Account</button></p></div></p>
<br>
<!-- commentd by sitesh on Sep 17 for email chk
...
/* Below Validation by Sitesh on Sep 09 */
 ...
 function ValidEmail(str)
 {
   ...
   xmlhttp.send();
     ...
     // Below code for enable/disable button
     /*
...
/* Below Validation by Sitesh on Sep 22 */

function ValidRollno(str)
 {
   // alert('Into Rollno Validation');
   ...
   xmlhttp.open("GET","getvalidrollno.php?qr="+str,true);
   xmlhttp.send();

...
if($submit)
{
	...
	else
	{
		...
		$command ='python forpass.py '.$email.' '.$accid.' '.$name;
		exec($command);



		/*
		$passchangecode="http://$mailsite/$directory/change_pass.php?id=$accid&code=$name";			
		
		//Send Activation Email
		$to=$email;
		$subject="Change your Password";
		$headers="From: vlabs.sbhs@gmail.com";
		...
		//echo " $passchangecode <br />"; 
		
		//The funtion to send email.
		mail($to, $subject, $body, $headers);
		*/
		die("Please Check you Email Inbox (or Spambox) for further instructions to change your Password!");	
	}
	
}
//else
	//die("Please Supply the Email ID");
?>
...
<tr>
	<td>
		<input type="submit" name="submit" value="Retrieve Passsword" />
	</td>
</table>

...
$hash = md5($hash.$stime.$etime.$rollno);


		$ip = $_SERVER['REMOTE_ADDR'];

		$gen_md = $ip.$date.$rollno.$stime.$etime.$mid;
...
<br><br>
<h2>Current Booking Page</h2>
</div>
<div id="messageBox"></div>
<div id="main"><div class="layout1"><form class="safeSubmit" 
method="post" id="signup_form" name="signup_form" 
action="current_booking_action.php">

<p class="group"><label for="rollno">Time : </label><label for="rollno"><b><? echo $stime." - ".$etime ?></b></label></p>

<p class="group"><label for="time">Date : </label><label for="time"><b><? echo $date ?></b></label></p>

<input type="hidden" value="<? echo $rollno ?>" name="rollno">
<input type="hidden" value="<? echo $stime ?>" name="stime">
<input type="hidden" value="<? echo $etime ?>" name="etime">
<input type="hidden" value="<? echo $mid ?>" name="mid">
<input type="hidden" value="<? echo $date?>" name="date">
<input type="hidden" value="<? echo $rno ?>" name="rno">

<p class="buttons"><button type="submit" id="next.x" name="next.x" +
class="primary">Book current slot</button></p>

...
mysql_select_db ("$db");
$stuff = mysql_query("SELECT * FROM `slot` where Srno='$srno'") or die("MySQL Login Error: ".mysql_error()); 
...
<h2>Edit time for <? echo $time; ?> slot</h2>
</div>
<div id="messageBox"></div>
<div id="main"><div class="layout1"><form class="safeSubmit" 
method="post" id="signup_form" name="signup_form" 
action="edit_slot_action.php">
<p>Please fill in all fields.</p>
<p class="group"><label for="rollno">Select start time :</label><span 
class="help">This will be the time at which the slot starts</span><span 
class="field"><select name="start">
...
<p class="group"><label for="rollno">Select end time :</label><span 
class="help">This will be the time at which the slot ends</span><span 
class="field"><select name="end">
<option value="0.00">0.00</option>
<option value="1.00">1.00</option>
<option value="2.00">2.00</option>
<option value="3.00">3.00</option>
...
class="primary">Create Slot</button></p>

</div>
<input type="hidden" value="<? echo $srno; ?>" name="srno" />
